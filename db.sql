...
-- Schema eshan_rest
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `eshan_rest` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `bnc_rest_api` ;
...
-- -----------------------------------------------------
-- Table `eshan_rest`.`delivery`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `eshan_rest`.`delivery` (
